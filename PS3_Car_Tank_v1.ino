 ...
 * This code drives the platform as a tank, with stop and turn steering. 
*/
...
// handle the input from the PS3 controllers
void notify() {
  long leftValue = (Ps3.data.analog.stick.ly);   //Left stick  - y axis - forward/backward car movement
  long rightValue = (Ps3.data.analog.stick.ry);  //Right stick - x axis - left/right car movement
  ...
  rotateMotor(rightValue, leftValue);
}
